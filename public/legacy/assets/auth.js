...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      "background:#2b1c24;",
      "font-family:'Avenir Next','Helvetica Neue',Helvetica,Arial,sans-serif;padding:1.5rem}",
      "#auth-gate .box{width:min(400px,92vw);background:#3a2630;border:1px solid #5c414e;",
      "border-radius:18px;box-shadow:0 20px 60px rgba(0,0,0,.38);padding:2rem 1.75rem;color:#fffaf6;text-align:center}",
      ...
      "#auth-gate input:focus{outline:2px solid #b97886}",
      "#auth-gate button{width:100%;font:inherit;font-weight:700;cursor:pointer;border:0;margin-top:.8rem;",
      "background:#b97886;color:#2b1c24;padding:.8rem;border-radius:12px;font-size:1rem}",
  ...
  function gate(mode, name) {
    ...
    wrap.innerHTML =
      '<div class="box">' +
        ...
        '<input id="auth-pin" type="password" inputmode="numeric" maxlength="8" placeholder="Digite o PIN" autocomplete="off">' +
